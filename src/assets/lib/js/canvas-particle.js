...
//var CanvasParticle = (
 export function CanvasParticle(canvasConfigs){
	...
	function drawPoint(canvas){
		...
		drawLine(context, canvas, canvas.mouse,dist);
		context.closePath();
	}
	...
	// 画线
	function drawLine(context, canvas, mouse,dist){
